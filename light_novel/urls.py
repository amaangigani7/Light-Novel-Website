...
urlpatterns = [
    ...
    path('characters/move_detail/<int:pk>/', views.move_detail, name='move_detail'),
    path('characters/chapter_detail/<int:pk>/', views.chapter_detail, name='chapter_detail'),
    path('characters/outfit_detail/<int:pk>/', views.outfit_detail, name='outfit_detail'),
    path('characters/sight_detail/<int:pk>/', views.sight_detail, name='sight_detail'),
    path('characters/timeline_detail/<int:pk>/', views.timeline_detail, name='timeline_detail'),
